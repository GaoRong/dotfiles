...
setup_tmux() {
    echo "\033[034m* setup tmux...\033[0m"
...
setup_git() {
    echo "\033[034m* setup Git...\033[0m"
...
setup_ubuntu_gui() {
    echo "\033[034m* install fonts..\033[0m"
    mkdir -p $HOME/.fonts
    ln -fs $BASE_DIR/ubuntu-gui/fonts/* $HOME/.fonts/
    fc-cache -vf # flush system font cache

    # setup link to terminator
